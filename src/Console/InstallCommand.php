...
namespace IbnuJa\Jetify\Console;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'jetify:install {--teams : Indicates if team support should be installed}
     ...
     * @var string
     */
    protected $description = 'Install the Jetify components and resources';
    ...
    protected function installInertiaStack()
    {
        ...
        $this->updateNodePackages(function () {
            return [
                ...
                "vite" => "^2.8.2",
                "vite-plugin-laravel" => "^0.2.0-beta.5",
